            ...
            <div className="grid grid-cols-1 gap-8">
                    ...
                    <div className="w-full md:w-3/4 mx-auto">
                        <div className="flex md:flex-row">
                            <div className="w-1/2 pr-4">
                                <img src={image1} alt="Изображение" className="w-full rounded" />
                            </div>
                ...
                <div className="flex items-center">
                    <div className="w-full md:w-3/4 mx-auto">
                        <div className="flex md:flex-row">
                            ...
                            <div className="w-1/2 ">
                                <img src={image2} alt="Изображение" className="w-full rounded" />
                            </div>
                        </div>
                    </div>
                </div>
                <div className="flex items-center">
                    <div className="w-full md:w-3/4 mx-auto">
                        <div className="flex md:flex-row">
                            <div className="w-1/2 pr-4">
                                <img src={image3} alt="Изображение" className="w-full rounded" />
                            </div>
                            <div className="w-1/2 flex flex-col justify-center">
                                <div className="p-4 rounded">
                ...
                <div className="flex items-center">
                    <div className="w-full md:w-3/4 mx-auto">
                        <div className="flex md:flex-row">
                            ...
                            <div className="w-1/2"><img src={image4} alt="Изображение" className="w-full rounded" /></div>
                        </div>
                    </div>
                </div>
            </div>
